...
def main():
    ...
    while True:
        ...
        pio.terminal.println("Temperature: %-3.1f C" % temperature)
        pio.terminal.println("Humidity: %-3.1f %%" % humidity)
        pio.terminal.println("---------------------------------------------")
        time.sleep(6)
...
class DHT11:
    ...
    def read(self):
        ...
        # chuyển nó sang input và pull_up
        ...
        return self.temperature, self.humidity # trar về kết quả
    ...
    def parse_data_pull_up_lengths(self, data):
        ...
        for i in range(len(data)):
            ...
            if state == STATE_DATA_PULL_UP:
                if current == GPIO.HIGH:
                    # data pulled up, độ dài của pull up sẽ quyết định đâu là 0 hoặc 1
                    current_length = 0
