...
const testArray = [
	...
	708, 323, 978, -60, -572, -828, 229, -400, -853, 826, 339, 407, 453, 717, -183, -705, 155, -730, -827, -593, 915, 528, 158, -936, -37, -83, 246, 911, 749, -592, -168, -911, 885, 41, -996, 742, -901, -865, 653, 873, 360, 207, 914, 553, -721, -18, -681, 675, -432, 413, -83
]
...
You can use testArray for testing by not entering input and just pressing Enter\n', elements => {
	...
	if (areAllNum) {
		...
		// For example: arr = BubbleSort.bubbleSort(arr);
		arr = SelectionSort.reverseSelectionSort(arr);
