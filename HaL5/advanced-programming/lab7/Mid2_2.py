class ComplexNumber:
    ...
    def divComplex(self, frac):
        ...
        '''
        return ComplexNumber((self.real * frac.real + self.image * frac.image)/(frac.real**2 + frac.image**2), (self.image * frac.real - self.real * frac.image)/(frac.real**2 + frac.image**2))
